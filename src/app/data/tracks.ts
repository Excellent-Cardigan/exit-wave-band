...
export const tracks: Track[] = [
  {
    ...
    album: 'Night Hymns',
    duration: '4:32',
    audioSrc: '/audio/moths-lament/moths-lament.mp3',
  ...
  },
  {
    ...
    album: 'Severance',
    duration: '5:47',
    audioSrc: '/audio/mounting-mountain-cemetary/mounting-mountain-cemetary.mp3',
  ...
  },
  {
    ...
    album: 'Demos Vol. 1',
    duration: '3:21',
    audioSrc: '/audio/soft-pain/soft-pain.mp3',
